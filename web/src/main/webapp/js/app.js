...
evasionVisiteurApp.config(['$routeProvider', 'RestangularProvider', '$locationProvider','$httpProvider', function($routeProvider, RestangularProvider, $locationProvider,$httpProvider) {
...
angular.injector(['ng', 'restangular']).invoke(function(Restangular, $rootScope) {
    evasionVisiteurApp.run(function($rootScope, Restangular, $route, $location) {
        ...
        Restangular.one($rootScope.subdomain + '.json').get('site').then(function(response) {
            //Restangular.one('site',1).get().then(function(response) {
